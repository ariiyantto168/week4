...
// string dan number. Parameter pertama merupakan memberId dan parameter ke-2 merupakan value uang yang dibawa oleh member tersebut
...
for (let i = 0; i < list.length; i++) {
    ...
    simpan.memberId = memberId;
    simpan.money = money;
    simpan.listPurchased = tampung;
    simpan.changeMoney = uang;
